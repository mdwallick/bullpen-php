...
class Bullpen_Extension_Shortcodes {
	...
	public function ShortApplication_Form_Shortcode_Handler( $atts ) {
      ...
      <input type="hidden" value="Website Application" name="source">
			...
			<div><input type='submit' class='button' value='Submit Application' name='submit'></div><?php
	...
	public function Application_Form_Shortcode_Handler( $atts ) {
		...
		// $fields_req = array('firstName', 'lastName', 'email', 'phone');

		// foreach ( $fields as $field => $name ) {

		// 	$required = in_array($field, $fields_req) ? 'required' : '';

		// 	echo "<div class='{$field}'><label for='{$field}'>{$name}
